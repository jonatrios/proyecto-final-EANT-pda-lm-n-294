...
sidebar = html.Div(
    [
        html.H2([html.A(html.Img(src='data:image/png;base64,{}'.format(encoded_image.decode())), href="/", title='Inicio')], className="rounded mx-auto d-block"),
        html.Hr(),
        html.P(
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink("GitHub (App)", href="https://github.com/jonatrios/proyecto-final-EANT-pda-lm-n-294", target="_blank",active="exact"),
                dbc.NavLink("GitHub (Data)", href="https://github.com/fernandorgonzalez/cursos-eant-python_data_analytics-proyecto#readme", target="_blank",active="exact"),
